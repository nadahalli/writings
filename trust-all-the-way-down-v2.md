...
You trust Apple. This works. Apple has the incentive and the resources to keep the pipeline clean. Google does the same. So does Microsoft. Your turst model is simple: delegate verification to a gatekeeper you trust.
